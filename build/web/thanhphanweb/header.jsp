<%-- 
    Document   : navigation
    Created on : Oct 17, 2017, 9:05:00 AM
    Author     : tanks
--%>
            ...
            <div class="header">
                ...
                <form action="ControllerCartBean">
                      <div class="header-top-nav">
                        <ul>
                            <li><a href="registration.jsp">Đăng ký</a></li>
                            <li><a href="login.jsp">Đăng nhập</a></li>
                            <li><a href="404.jsp">Thanh toán</a></li>
            ...
            <div class="wrap">
                ...
                <div class="top-nav">
                    <ul>
                        ...
                        <li><a href="404.jsp">Thông tin</a></li>
                        <li><a href="index.jsp">Cửa hàng</a></li>
